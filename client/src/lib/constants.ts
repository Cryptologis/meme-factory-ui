...
// Make sure this matches your newly deployed program with 9 decimals!
...
// ===== TOKEN DECIMALS - UPDATED FROM 6 TO 9 =====
export const TOKEN_DECIMALS = 9;
export const TOKEN_MULTIPLIER = Math.pow(10, TOKEN_DECIMALS); // 1,000,000,000

// ===== BONDING CURVE CONSTANTS (9 DECIMALS) =====
export const TOTAL_SUPPLY = 1_000_000_000_000_000_000n; // 1B tokens with 9 decimals
export const VIRTUAL_SOL_RESERVES = 30_000_000_000n; // 30 SOL in lamports
export const VIRTUAL_TOKEN_RESERVES = 1_073_000_000_000_000_000n; // 1.073B tokens with 9 decimals
export const REAL_TOKEN_RESERVES_INITIAL = 800_000_000_000_000_000n; // 800M for bonding curve
